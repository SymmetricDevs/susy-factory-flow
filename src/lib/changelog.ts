 ...
 * 3.1.4 deliberately carries a full engineering explanation at Jack's request:
 * previous behaviour, corrected rules, numerical examples and model limits.
 * Keep that detail in the version-chip history where readers can revisit it.
 *
