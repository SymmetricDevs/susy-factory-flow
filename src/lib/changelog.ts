...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    notes: [
      ...
      "Right click anywhere: the empty board adds a product drawer, a card clones or deletes, and a wire deletes or gets a drawer cut into it where you clicked.",
      "The rate labels on wires are gone; the ports carry the numbers.",
