...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    notes: [
      ...
      "The machine tabs above a card are gone: a chevron by the name opens the machine list, and every card tooltip now states rates, requirements and the gestures on offer.",
    ],
  },
  {
    version: "2.57.0",
