...
export function SpawnKeys({ leading }: { leading?: ReactNode }) {
  ...
  const key =
    "flex h-12 min-w-0 flex-1 flex-col items-center justify-center gap-1 rounded border border-neutral-700 px-1.5 text-[11px] font-medium text-neutral-300 hover:border-neutral-500 hover:text-neutral-100";
