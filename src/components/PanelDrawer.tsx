...
export function PanelDrawer({
  ...
  const getPanelWidth = () =>
    ...
    Math.min((document.documentElement.clientWidth / getUiScale()) * 0.88, side === "left" ? 256 : 312);
      ...
      {isMounted ? (
        <div
          ...
          className={[
            ...
            // 256 and 312 are the columns' desktop widths; a phone gets as much
            // of that as it can spare while still showing the board behind.
            side === "left"
              ? "left-0 w-[min(calc(88*var(--ui-vw)),256px)]"
              : "right-0 w-[min(calc(88*var(--ui-vw)),312px)]",
