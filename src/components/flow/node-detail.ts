...
/**
 * Below this the board drops to the glance view. 0.8 (raised from 0.6, Jack,
 * 2026-09-08: the glance should take over sooner on the way out) is roughly
 * where a port row's lettering falls under eight screen pixels: the moment
 * the card stops being readable is the moment the glance takes over, rather than three
 * wheel-steps later with the board a smear in between.
 */
export const NODE_GLANCE_ENTER_ZOOM = 0.8;
/** And above this it comes back. The gap is the anti-flicker dead zone. */
export const NODE_GLANCE_LEAVE_ZOOM = 0.86;
